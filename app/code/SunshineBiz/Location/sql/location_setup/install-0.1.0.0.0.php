...
$table = $installer->getConnection()
	...
	->addColumn('created_at', Varien_Db_Ddl_Table::TYPE_TIMESTAMP, null, array(
        ...
        ->addIndex($installer->getIdxName('location_area', array('default_name', 'parent_id', 'region_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE), 
...
$installer->getConnection()->addColumn($installer->getTable('directory_country_region'), 'default_abbr', array(
    'type' => Varien_Db_Ddl_Table::TYPE_TEXT,
    'length' => 30,
    'comment' => 'Region Default Abbreviation Name'
));

$installer->getConnection()->addColumn($installer->getTable('directory_country_region_name'), 'abbr', array(
    'type' => Varien_Db_Ddl_Table::TYPE_TEXT,
    'length' => 30,
